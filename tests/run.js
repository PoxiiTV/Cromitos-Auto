/*
 * Tests for the pure logic in cromitos-auto.user.js.
 *
 *   node tests/run.js
 *
...
const SCRIPT = path.join(__dirname, '..', 'cromitos-auto.user.js');
...
function loadScript(walletInfo) {
    ...
    vm.runInContext(fs.readFileSync(SCRIPT, 'utf8'), sandbox, { filename: 'cromitos-auto.user.js' });
